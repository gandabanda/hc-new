...
<body id="top">
            ...
            <header>
                <div class="header-content row">
                    <div class="nav-left col-md-2">
                    	<div class="logo">
                    		<a href="#"><img src="img/logo-header.png" alt="Hazim Consulting"></a>
                    		<div class="slogan">International Expertise,<br><b>Local Experience.</b></div>
                    	</div>
                	</div>
                    <div class="nav-right col-md-10">
	                    <div class="header-nav social-nav">
	                        <nav>
	                            <ul class="social-nav">
            ...
            <div class="row">
                <div class="col-md-10 col-md-offset-1">
                    <div class="hero-content text-center">
                        <h1>Over 70 years</h1>
                        <p class="intro">of learned experience</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="gradient-border">a</div>
            ...
            <div class="row">
                <div class="col-md-7">
                    <div class="footer-links">
                        ...
                        <p>© Copyright 2013. Hazim Consulting all rights reserved.<br>
                        <a href="http://tympanus.net/codrops/licensing/">License</a> | Crafted with <span class="fa fa-heart pulse2"></span> by <a href="http://www.peterfinlan.com/">Peter Finlan</a>.</p>
                    </div>
                </div>
